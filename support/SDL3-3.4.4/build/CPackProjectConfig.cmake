if(CPACK_PACKAGE_FILE_NAME MATCHES ".*-src$")
    message(FATAL_ERROR "Creating source archives for SDL 3.4.4 is not supported.")
endif()

set(PROJECT_SOURCE_DIR "/mnt/c/Dev/Prizm/support/SDL3-3.4.4")
...
set(CPACK_PACKAGE_FILE_NAME "SDL3-3.4.4-${SDL_CMAKE_PLATFORM}${SDL_CPU_NAMES_WITH_DASHES}")

if(CPACK_GENERATOR STREQUAL "DragNDrop")
    set(CPACK_DMG_VOLUME_NAME "SDL3 3.4.4")
